		...
		function printHidden(){
			var hiddenValue=document.getElementById('webSocketsDashboardForm:jsfWSCWebSocketsDashboardID').value;
			console.log(hiddenValue);
			//alert(hiddenValue);
			onWebSocketsDashboardMessage(hiddenValue);
		}

		
		function onWebSocketsDashboardMessage(data) {
        ...
        document.getElementById('gsDashboardForm:databaseDashboardButton').click();
        }, 30*1000);*/
        window.onload= function() { 
        	document.getElementById('webSocketsDashboardForm:webSocketsDashboardButtonID').click();
        }
