		...
		function printHidden(){
			var hiddenValue=document.getElementById('gsDashboardForm:databaseDashboardJsonDataId').value;
			console.log(hiddenValue);
			//alert(hiddenValue);
			onDashboardMessage(hiddenValue);
		}

		

		function onDashboardMessage(data) {
